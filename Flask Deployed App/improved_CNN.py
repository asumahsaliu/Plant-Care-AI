"""
Improved CNN Model for Flask Deployment
Uses transfer learning with ResNet50 for better accuracy
"""
...
class EfficientNetModel(nn.Module):
    """
    Alternative: EfficientNet-B0 for better efficiency
    """
...
# Keep original CNN for backward compatibility
class CNN(nn.Module):
    def __init__(self, K):
